...
out12 <- NMF(X, J=3, algorithm="Projected", num.iter=2)
out13 <- NMF(X, J=3, algorithm="NHR", num.iter=2)
out14 <- NMF(X, J=3, algorithm="DTPP", num.iter=2)
out15 <- NMF(X, J=3, algorithm="Orthogonal", num.iter=2)
out16 <- NMF(X, J=3, algorithm="OrthReg", num.iter=2)
