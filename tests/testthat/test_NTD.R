...
expect_equivalent(length(out_NTD2_1), 4)
expect_equivalent(length(out_NTD2_2), 4)
expect_equivalent(length(out_NTD2_3), 4)

expect_equivalent(length(out_NTD1_1), 4)
expect_equivalent(length(out_NTD1_2), 4)
expect_equivalent(length(out_NTD1_3), 4)
...
# expect_equivalent(length(out_NTD4_1_1), 4)
# expect_equivalent(length(out_NTD4_1_2), 4)
# expect_equivalent(length(out_NTD4_1_3), 4)
# expect_equivalent(length(out_NTD4_2), 4)
# expect_equivalent(length(out_NTD4_3), 4)
# expect_equivalent(length(out_NTD4_4), 4)
# expect_equivalent(length(out_NTD4_5), 4)
# expect_equivalent(length(out_NTD4_6), 4)
# expect_equivalent(length(out_NTD4_7), 4)
# expect_equivalent(length(out_NTD4_8), 4)
# expect_equivalent(length(out_NTD4_9), 4)

# expect_equivalent(length(out_NTD4_3_1), 4)
# expect_equivalent(length(out_NTD4_3_2), 4)
# expect_equivalent(length(out_NTD4_3_3), 4)
# expect_equivalent(length(out_NTD4_3_4), 4)

# expect_equivalent(length(out_NTD4_2_1), 4)
# expect_equivalent(length(out_NTD4_2_2), 4)
# expect_equivalent(length(out_NTD4_2_3), 4)
# expect_equivalent(length(out_NTD4_2_4), 4)
# expect_equivalent(length(out_NTD4_2_5), 4)
# expect_equivalent(length(out_NTD4_2_6), 4)

# expect_equivalent(length(out_NTD4_1_1), 4)
# expect_equivalent(length(out_NTD4_1_2), 4)
# expect_equivalent(length(out_NTD4_1_3), 4)
# # Too heavy
# # expect_equivalent(length(out_NTD4_1_4), 4)
